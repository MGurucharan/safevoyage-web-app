        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex items-center text-gray-600 mb-4">
                  ...
                  <span className="text-lg">{place.district}, {place.region}, {place.country}</span>
                </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className={`px-4 py-2 rounded-full bg-gradient-to-r ${getSafetyScoreColor(place.aiSafetyScore)} text-white text-lg font-bold`}>
                    {place.aiSafetyScore}/10
                  </div>
                </div>
                <p className="text-gray-600 mb-4">
                  {getSafetyScoreText(place.aiSafetyScore)} safety rating based on comprehensive analysis
                </p>
                <div className="text-sm text-gray-500">
                  • Safety & Security Assessment<br/>
                  • Affordability & Value Analysis<br/>
                  • Accessibility & Infrastructure<br/>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg">
            ...
            <div className="mt-6 text-center text-sm text-blue-600 bg-blue-50 p-4 rounded-lg">
              💡 Reviews are updated in real-time from multiple travel platforms and user feedback
            </div>
          </div>
        </div>
      </div>
